...
API_ID = int(environ.get('API_ID', '24336610'))
API_HASH = environ.get('API_HASH', '1b4f44a32897fc4b01c5863d3c76f600')
BOT_TOKEN = environ.get('BOT_TOKEN', "7930649283:AAGzhKObW_U4qd53pchPHJbF28oLzHlkZOo")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1933087805', '').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('-1002320725497', ''))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002519751703', '').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('-1002056018561', '') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002779723060')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002583405994')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sahootapas1220: a1jRE55FVfRdZA3r@cluster0.hpvulsw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "techANclonefilterbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'ANcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/aayan_official_321')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+wdhxQbNp-GAwZDI1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/+w9ZRszAxG_QxOTM1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/aayan_here')
